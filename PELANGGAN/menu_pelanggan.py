...
class Pelanggan:
    def __init__(self):
        ...
        file_path = os.path.abspath("DATA/dataloginP.json")
    ...
    def save_userA(self):
        ...
        with open("DATA/dataloginP.json", "w") as file:
...
# Registrasi dan Login sebagai fungsi terpisah
def registrasi(customer):
    user_data = customer.load_accounts()
...
def login(customer):
    ...
    if user_data.get(username) == password:
        ...
        pembelian_menu()  # Masuk ke menu pembelian
    else:
...
# Menu utama
def main_pelanggan():
    cus = Pelanggan()  # Inisialisasi Admin
    while True:
        print("\n=== Sistem Login ===")
        print("1. Registrasi")
        print("2. Login")
